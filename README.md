...
This package declares [EDM4U](https://github.com/googlesamples/unity-jar-resolver) as a transitive dependency (for consistency with the rest of the `com.bizsim.google.play.*` family), resolved via the **OpenUPM** scoped registry. Add the registry once and Unity Package Manager auto-installs EDM4U.
...
|---------|-------------|
| [Age Signals](https://github.com/BizSim-Game-Studios/com.bizsim.google.play.agesignals) | `BIZSIM_FIREBASE` define for optional analytics |
...
| [Games Services](https://github.com/BizSim-Game-Studios/com.bizsim.google.play.games) | Package Dashboard integration |
